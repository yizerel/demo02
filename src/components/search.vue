...
<div>
        ...
        <van-tab title="电影">
                ...
                <img width=180 height=280 src="../assets/images/d3.jpg"> <img width=180 height=280 src="../assets/images/d4.jpg">
        </van-tab>
        <van-tab title="购物">      
                <img width=180 height=280 src="../assets/images/s1.jpg"> <img width=180 height=280 src="../assets/images/s2.jpg">
